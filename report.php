...
}else if(!is_int($dimensions1) || !is_int($dimensions2) || !is_int($dimensions2)){
...
}else if(!is_int($valueOfPackages)){
...
<html>
    ...
    <body>
        ...
        <span><?php echo $dimensions1; echo $dimensions2; echo $dimensions3; ?></span><br>
